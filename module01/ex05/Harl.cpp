...
/*   Updated: 2024/04/05 21:03:24 by drenassi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Harl::debug()
{
	...
	std::cout << "burger. I really do!\"" << END_COLOR << std::endl;
}
...
void	Harl::info()
{
	...
	std::cout << "burger! If you did, I wouldn't be asking for more!\"";
...
void	Harl::error()
{
	std::cout << "\tHarl says:\n\t" << MAGENTA << "\"This is unacceptable! I want ";
